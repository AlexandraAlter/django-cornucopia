...
class Migration(migrations.Migration):
    ...
    replaces = [('cornucopia', '0001_initial'), ('cornucopia', '0002_board'),
                ('cornucopia', '0003_board_name')]
            ...
            fields=[
                ...
                ('edit',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                   related_name='new_tags',
                                   to='cornucopia.postedit')),
            ],
            options={
                'abstract': False,
            },
